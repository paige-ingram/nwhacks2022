...
var FacepileBase = /** @class */ (function (_super) {
    ...
    FacepileBase.prototype._getElementWithOnClickEvent = function (personaControl, persona, index) {
        ...
        return (React.createElement(FacepileButton_1.FacepileButton, tslib_1.__assign({}, Utilities_1.getNativeProps(persona, Utilities_1.buttonProperties), this._getElementProps(persona, index), { keytipProps: keytipProps, 
