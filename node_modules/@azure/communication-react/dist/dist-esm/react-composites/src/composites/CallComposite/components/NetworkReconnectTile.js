...
export const NetworkReconnectTile = (props) => {
    ...
    return (React.createElement(ExpandedLocalVideoTile, Object.assign({ localParticipantVideoStream: props.localParticipantVideoStream, overlayContent: React.createElement(Stack, { verticalFill: true, horizontalAlign: "center", verticalAlign: "center", className: mergeStyles(containerStyle) },
            React.createElement(Stack, { horizontal: true, className: mergeStyles(titleContainerStyle) },
                React.createElement(Icon, { iconName: "NetworkReconnectIcon", className: mergeStyles(titleStyle) }),
                React.createElement(Text, { className: mergeStyles(titleStyle(palette, isVideoReady)), "aria-live": 'polite' }, strings.networkReconnectTitle)),
            React.createElement(Text, { className: mergeStyles(moreDetailsStyle(palette, isVideoReady)), "aria-live": 'polite' }, strings.networkReconnectMoreDetails)) }, handlers)));
};
