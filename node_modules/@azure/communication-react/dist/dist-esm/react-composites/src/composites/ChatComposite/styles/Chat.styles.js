 ...
 * @private
 */
export const sendBoxChatCompositeStyles = {
    textFieldContainer: { maxWidth: MESSAGE_THREAD_WIDTH }
};
/**
 * @private
 */
export const messageThreadChatCompositeStyles = { root: { maxWidth: MESSAGE_THREAD_WIDTH } };
/**
 * @private
 */
export const typingIndicatorChatCompositeStyles = {
    typingString: { maxWidth: MESSAGE_THREAD_WIDTH }
};
/**
 * @private
 */
export const typingIndicatorContainerStyles = {
    width: '100%',
