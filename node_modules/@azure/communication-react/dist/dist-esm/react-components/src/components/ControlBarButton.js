...
export const ControlBarButton = (props) => {
    ...
    return (React.createElement(ControlButtonTooltip, { content: tooltipContent, id: tooltipId },
        React.createElement(DefaultButton, Object.assign({}, props, { styles: componentStyles, onRenderText: props.showLabel && props.onRenderText ? props.onRenderText : undefined, onRenderIcon: (_o = props.onRenderIcon) !== null && _o !== void 0 ? _o : DefaultRenderIcon, ariaLabel: tooltipContent }), props.showLabel ? labelText : React.createElement(React.Fragment, null))));
};
